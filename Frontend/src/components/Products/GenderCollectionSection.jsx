      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="relative flex-1">
          ...
          <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-4">
            ...
            <Link to="/collections/all?gender=Women" className="text-blue-600 hover:underline">
              Shop Now
            </Link>
          </div>
        </div>
        ...
        <div className="relative flex-1">
          ...
          <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-4">
            ...
            <Link to="/collections/all?gender=Men" className="text-blue-600 hover:underline">
              Shop Now
            </Link>
          </div>
        </div>
