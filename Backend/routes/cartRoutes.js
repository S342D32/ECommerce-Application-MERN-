...
// @route POST /api/cart
// @desc Add a product to the cart for a gust or logged in user
//@access Public
...
//@route PUT /api/cart
//@desc Update prod qty in the cart for a guest or logged in user
//@access public
